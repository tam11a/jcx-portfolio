	...
	return (
		<div>
			...
			>
				...
				<button
					className={`absolute top-8 sm:top-1/2 left-full ${
						open
			...
			{open && (
				<div className="z-[99] fixed top-0 left-0 h-screen w-screen bg-background-light backdrop-filter bg-opacity-70 backdrop-blur-sm" />
			)}
		</div>
	);
};
